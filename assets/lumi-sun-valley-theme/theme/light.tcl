...
namespace eval ttk::theme::lumi_sv_light {
  package provide ttk::theme::lumi_sv_light 2.5
  ...
  proc load_images {imgfile} {
    variable I
    image create photo lumi_spritesheet_light -file $imgfile -format png
    foreach {name x y width height} $::spriteinfo {
      set I($name) [image create photo -width $width -height $height]
      $I($name) copy lumi_spritesheet_light -from $x $y [expr {$x+$width}] [expr {$y+$height}]
    }
  }

  load_images [file join [file dirname [info script]] spritesheet_light.png]

  ttk::style theme create lumi-sun-valley-light -parent clam -settings {
    ...
    ttk::style configure TButton -padding {6 1 6 2} -anchor center -foreground $colors(-fg)
    ...
    ttk::style configure Toolbutton -padding {6 1 6 2} -anchor center
    ...
    ttk::style configure Accent.TButton -padding {6 1 6 2} -anchor center -foreground "#ffffff"
    ttk::style map Accent.TButton -foreground [list pressed "#f4edf7" disabled "#ffffff"]
    ...
    ttk::style configure TMenubutton -padding {6 1 10 2}
    ...
    ttk::style configure TOptionMenu -padding {6 1 10 2}
    ...
    ttk::style configure Toggle.TButton -padding {6 1 6 2} -anchor center -foreground $colors(-fg)
    ...
    # Entry
    ttk::style configure TEntry -foreground $colors(-fg) -padding {5 0 3 1}
    ...
    ttk::style configure TCombobox -foreground $colors(-fg) -padding {5 0 0 1}
    ...
    ttk::style element create Combobox.arrow image $I(down) -width 28 -sticky {}
    ...
    ttk::style configure TSpinbox -foreground $colors(-fg) -padding {5 0 0 1}
    ...
    ttk::style element create Spinbox.uparrow image $I(up) -width 28 -height 14 -sticky {}
    ttk::style element create Spinbox.downarrow image $I(down) -width 28 -height 14 -sticky {}
    ...
    ttk::style element create Labelframe.border image $I(card) -border 5 -padding 3 -sticky nsew
    ttk::style configure TLabelframe.Label -font LumiSunValleyCaptionFont
    ...
    ttk::style configure TNotebook.Tab -font LumiSunValleyCaptionFont
    ttk::style element create Notebook.border image $I(empty) -border 0 -padding 0

    ttk::style element create Notebook.tab image \
      [list $I(tab-rest) \
        selected $I(tab-selected) \
        active $I(tab-hover) \
      ] -border 11 -padding {10 5 10 4} -height 24

    # Treeview
    ttk::style configure Heading -font LumiSunValleyCaptionFont
    ttk::style configure Treeview \
        -background $colors(-bg) \
        -rowheight [expr {[font metrics LumiSunValleyBodyFont -linespace] + 3}] \
